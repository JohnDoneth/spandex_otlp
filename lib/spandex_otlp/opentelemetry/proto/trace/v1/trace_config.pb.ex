...
defmodule SpandexOTLP.Opentelemetry.Proto.Trace.V1.TraceConfig do
  ...
  field :constant_sampler, 1, type: SpandexOTLP.Opentelemetry.Proto.Trace.V1.ConstantSampler, oneof: 0
  field :trace_id_ratio_based, 2, type: SpandexOTLP.Opentelemetry.Proto.Trace.V1.TraceIdRatioBased, oneof: 0
